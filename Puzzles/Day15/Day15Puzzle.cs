...
{
    public abstract class Day15Puzzle : PuzzleBase
    {
        protected override string GetPuzzleData()
        {
            return "/Day15Data.txt";
        }

        protected Dictionary<IntVector2, int> mapData = new Dictionary<IntVector2, int>();

        protected IntVector2 origin = new IntVector2(0,0);
        protected IntVector2 target;
